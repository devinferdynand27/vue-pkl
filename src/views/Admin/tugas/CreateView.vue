  ...
  <div class="p-4 sm:ml-64">
    ...
    <div class="card shadow-md pl-4 pr-4">
      ...
      <form @submit.prevent="addtugas" class="pl-4 pr-4" method="post">
        ...
        <input v-model="addtugass.nama_tugas" type="text" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="john.doe@company.com" required>
    </div> 
